...
#define SEG_RESET_SIZE  0x00001000 // 4Ko

#define SEG_KCODE_BASE  0x80000000 
#define SEG_KCODE_SIZE  0x00004000 // 16Ko

#define SEG_KDATA_BASE  0x82000000
#define SEG_KDATA_SIZE  0x00010000 // 64Ko

#define SEG_KUNC_BASE   0x81000000
#define SEG_KUNC_SIZE   0x00001000 // 4Ko

#define SEG_DATA_BASE   0x01000000
#define SEG_DATA_SIZE   0x00004000 // 16Ko

#define SEG_CODE_BASE   0x00400000
#define SEG_CODE_SIZE   0x00004000 // 16Ko

#define SEG_STACK_BASE  0x02000000
#define SEG_STACK_SIZE  0x00004000 // 16Ko

#define SEG_TTY_BASE    0x90000000
#define SEG_TTY_SIZE    0x00000010 // 16o
...
int _main (int argc, char *argv[])
{
    ...
    size_t  icache_words    	= 32;	// instruction cache number of words per line
    size_t  dcache_ways     	= 1 ;	// data cache number of ways
    size_t  dcache_sets     	= 32;	// data cache number of sets
    size_t  dcache_words    	= 32;	// data cache number of words per line
